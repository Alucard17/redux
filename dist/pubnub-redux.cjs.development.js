...
})(exports.MembershipActionType || (exports.MembershipActionType = {})); // end::RDX-enum-memberships-action[]

var joiningSpaces = function joiningSpaces(payload, meta) {
  return {
    type: exports.MembershipActionType.JOINING_SPACES,
    payload: payload,
    meta: meta
  };
...
var spacesJoined = function spacesJoined(payload, meta) {
  return {
    type: exports.MembershipActionType.SPACES_JOINED,
    payload: payload,
    meta: meta
  };
...
var errorJoiningSpaces = function errorJoiningSpaces(payload, meta) {
  return {
    type: exports.MembershipActionType.ERROR_JOINING_SPACES,
    payload: payload,
    meta: meta,
    error: true
  };
...
var joinSpaces = function joinSpaces(request, meta) {
  ...
  thunkFunction.type = exports.MembershipActionType.JOIN_SPACES_COMMAND;
  return thunkFunction;
}; // end::RDX-command-spaces-join[]

var leavingSpaces = function leavingSpaces(payload, meta) {
  return {
    type: exports.MembershipActionType.LEAVING_SPACES,
    payload: payload,
    meta: meta
  };
...
var spacesLeft = function spacesLeft(payload, meta) {
  return {
    type: exports.MembershipActionType.SPACES_LEFT,
    payload: payload,
    meta: meta
  };
...
var errorLeavingSpaces = function errorLeavingSpaces(payload, meta) {
  return {
    type: exports.MembershipActionType.ERROR_LEAVING_SPACES,
    payload: payload,
    meta: meta,
    error: true
  };
...
var leaveSpaces = function leaveSpaces(request, meta) {
  ...
  thunkFunction.type = exports.MembershipActionType.LEAVE_SPACES_COMMAND;
  return thunkFunction;
}; // end::RDX-command-spaces-leave[]

var fetchingMembership = function fetchingMembership(payload, meta) {
  return {
    type: exports.MembershipActionType.FETCHING_MEMBERSHIP,
    payload: payload,
    meta: meta
  };
...
var membershipRetrieved = function membershipRetrieved(payload, meta) {
  return {
    type: exports.MembershipActionType.MEMBERSHIP_RETRIEVED,
    payload: payload,
    meta: meta
  };
...
var errorFetchingMembership = function errorFetchingMembership(payload, meta) {
  return {
    type: exports.MembershipActionType.ERROR_FETCHING_MEMBERSHIP,
    payload: payload,
    meta: meta,
    error: true
  };
...
var fetchMemberships = function fetchMemberships(request, meta) {
  ...
  thunkFunction.type = exports.MembershipActionType.FETCH_MEMBERSHIP_COMMAND;
  return thunkFunction;
}; // end::RDX-command-memberships-fetch[]

var updatingMemberships = function updatingMemberships(payload, meta) {
  return {
    type: exports.MembershipActionType.UPDATING_MEMBERSHIP,
    payload: payload,
    meta: meta
  };
...
var membershipUpdated = function membershipUpdated(payload, meta) {
  return {
    type: exports.MembershipActionType.MEMBERSHIP_UPDATED,
    payload: payload,
    meta: meta
  };
...
var errorUpdatingMembership = function errorUpdatingMembership(payload, meta) {
  return {
    type: exports.MembershipActionType.ERROR_UPDATING_MEMBERSHIP,
    payload: payload,
    meta: meta,
    error: true
  };
...
var updateMembership = function updateMembership(request, meta) {
  ...
  thunkFunction.type = exports.MembershipActionType.UPDATE_MEMBERSHIP_COMMAND;
  return thunkFunction;
...
})(exports.MembersActionType || (exports.MembersActionType = {})); // end::RDX-enum-memmber-action[]

var fetchingMembers = function fetchingMembers(payload, meta) {
  return {
    type: exports.MembersActionType.FETCHING_MEMBERS,
    payload: payload,
    meta: meta
  };
...
var membersRetrieved = function membersRetrieved(payload, meta) {
  return {
    type: exports.MembersActionType.MEMBERS_RETRIEVED,
    payload: payload,
    meta: meta
  };
...
var errorFetchingMembers = function errorFetchingMembers(payload, meta) {
  return {
    type: exports.MembersActionType.ERROR_FETCHING_MEMBERS,
    payload: payload,
    meta: meta,
    error: true
  };
...
var fetchMembers = function fetchMembers(request, meta) {
  ...
  thunkFunction.type = exports.MembersActionType.FETCH_MEMBERS_COMMAND;
  return thunkFunction;
}; // end::RDX-command-member-fetch[]

var updatingMembers = function updatingMembers(payload, meta) {
  return {
    type: exports.MembersActionType.UPDATING_MEMBERS,
    payload: payload,
    meta: meta
  };
...
var membersUpdated = function membersUpdated(payload, meta) {
  return {
    type: exports.MembersActionType.MEMBERS_UPDATED,
    payload: payload,
    meta: meta
  };
...
var errorUpdatingMembers = function errorUpdatingMembers(payload, meta) {
  return {
    type: exports.MembersActionType.ERROR_UPDATING_MEMBERS,
    payload: payload,
    meta: meta,
    error: true
  };
...
var updateMembers = function updateMembers(request, meta) {
  ...
  thunkFunction.type = exports.MembersActionType.UPDATE_MEMBERS_COMMAND;
  return thunkFunction;
}; // end::RDX-command-members-update[]

var addingMembers = function addingMembers(payload, meta) {
  return {
    type: exports.MembersActionType.ADDING_MEMBERS,
    payload: payload,
    meta: meta
  };
...
var membersAdded = function membersAdded(payload, meta) {
  return {
    type: exports.MembersActionType.MEMBERS_ADDED,
    payload: payload,
    meta: meta
  };
...
var errorAddingMembers = function errorAddingMembers(payload, meta) {
  return {
    type: exports.MembersActionType.ERROR_ADDING_MEMBERS,
    payload: payload,
    meta: meta,
    error: true
  };
...
var addMembers = function addMembers(request, meta) {
  ...
  thunkFunction.type = exports.MembersActionType.ADD_MEMBERS_COMMAND;
  return thunkFunction;
}; // end::RDX-command-member-add[]

var removingMembers = function removingMembers(payload, meta) {
  return {
    type: exports.MembersActionType.REMOVING_MEMBERS,
    payload: payload,
    meta: meta
  };
...
var membersRemoved = function membersRemoved(payload, meta) {
  return {
    type: exports.MembersActionType.MEMBERS_REMOVED,
    payload: payload,
    meta: meta
  };
...
var errorRemovingMembers = function errorRemovingMembers(payload, meta) {
  return {
    type: exports.MembersActionType.ERROR_REMOVING_MEMBERS,
    payload: payload,
    meta: meta,
    error: true
  };
...
var removeMembers = function removeMembers(request, meta) {
  ...
  thunkFunction.type = exports.MembersActionType.REMOVE_MEMBERS_COMMAND;
  return thunkFunction;
...
})(exports.MessageActionType || (exports.MessageActionType = {})); // end::RDX-enum-messages-action[]
...
})(exports.SignalActionType || (exports.SignalActionType = {})); // end::RDX-enum-signals-action[]
...
})(exports.SpaceActionType || (exports.SpaceActionType = {})); // end::RDX-enum-space-action[]

var creatingSpace = function creatingSpace(payload, meta) {
  return {
    type: exports.SpaceActionType.CREATING_SPACE,
    payload: payload,
    meta: meta
  };
...
var spaceCreated = function spaceCreated(payload, meta) {
  return {
    type: exports.SpaceActionType.SPACE_CREATED,
    payload: payload,
    meta: meta
  };
...
var errorCreatingSpace = function errorCreatingSpace(payload, meta) {
  return {
    type: exports.SpaceActionType.ERROR_CREATING_SPACE,
    payload: payload,
    meta: meta,
    error: true
  };
...
var createSpace = function createSpace(request, meta) {
  ...
  thunkFunction.type = exports.SpaceActionType.CREATE_SPACE_COMMAND;
  return thunkFunction;
}; // end::RDX-command-space-create[]

var deletingSpace = function deletingSpace(payload, meta) {
  return {
    type: exports.SpaceActionType.DELETING_SPACE,
    payload: payload,
    meta: meta
  };
...
var spaceDeleted = function spaceDeleted(payload, meta) {
  return {
    type: exports.SpaceActionType.SPACE_DELETED,
    payload: payload,
    meta: meta
  };
...
var errorDeletingSpace = function errorDeletingSpace(payload, meta) {
  return {
    type: exports.SpaceActionType.ERROR_DELETING_SPACE,
    payload: payload,
    meta: meta,
    error: true
  };
...
var deleteSpace = function deleteSpace(request, meta) {
  ...
  thunkFunction.type = exports.SpaceActionType.DELETE_SPACE_COMMAND;
  return thunkFunction;
}; // end::RDX-command-space-delete[]

var fetchingSpaceById = function fetchingSpaceById(payload, meta) {
  return {
    type: exports.SpaceActionType.FETCHING_SPACE_BY_ID,
    payload: payload,
    meta: meta
  };
...
var spaceRetrieved = function spaceRetrieved(payload, meta) {
  return {
    type: exports.SpaceActionType.SPACE_RETRIEVED,
    payload: payload,
    meta: meta
  };
...
var errorFetchingSpaceById = function errorFetchingSpaceById(payload, meta) {
  return {
    type: exports.SpaceActionType.ERROR_FETCHING_SPACE_BY_ID,
    payload: payload,
    meta: meta,
    error: true
  };
...
var fetchSpaceById = function fetchSpaceById(request, meta) {
  ...
  thunkFunction.type = exports.SpaceActionType.FETCH_SPACE_BY_ID_COMMAND;
  return thunkFunction;
}; // end::RDX-command-space-fetchbyid[]

var fetchingSpaces = function fetchingSpaces(payload, meta) {
  return {
    type: exports.SpaceActionType.FETCHING_SPACES,
    payload: payload,
    meta: meta
  };
...
var spacesRetrieved = function spacesRetrieved(payload, meta) {
  return {
    type: exports.SpaceActionType.SPACES_RETRIEVED,
    payload: payload,
    meta: meta
  };
...
var errorFetchingSpaces = function errorFetchingSpaces(payload, meta) {
  return {
    type: exports.SpaceActionType.ERROR_FETCHING_SPACES,
    payload: payload,
    meta: meta,
    error: true
  };
...
var fetchSpaces = function fetchSpaces(request, meta) {
  ...
  thunkFunction.type = exports.SpaceActionType.FETCH_SPACES_COMMAND;
  return thunkFunction;
}; // end::RDX-command-space-fetch[]

var updatingSpace = function updatingSpace(payload, meta) {
  return {
    type: exports.SpaceActionType.UPDATING_SPACE,
    payload: payload,
    meta: meta
  };
...
var spaceUpdated = function spaceUpdated(payload, meta) {
  return {
    type: exports.SpaceActionType.SPACE_UPDATED,
    payload: payload,
    meta: meta
  };
...
var errorUpdatingSpace = function errorUpdatingSpace(payload, meta) {
  return {
    type: exports.SpaceActionType.ERROR_UPDATING_SPACE,
    payload: payload,
    meta: meta,
    error: true
  };
...
var updateSpace = function updateSpace(request, meta) {
  ...
  thunkFunction.type = exports.SpaceActionType.UPDATE_SPACE_COMMAND;
  return thunkFunction;
...
})(exports.UserActionType || (exports.UserActionType = {})); // end::RDX-enum-user-action[]

var creatingUser = function creatingUser(payload, meta) {
  return {
    type: exports.UserActionType.CREATING_USER,
    payload: payload,
    meta: meta
  };
...
var userCreated = function userCreated(payload, meta) {
  return {
    type: exports.UserActionType.USER_CREATED,
    payload: payload,
    meta: meta
  };
...
var errorCreatingUser = function errorCreatingUser(payload, meta) {
  return {
    type: exports.UserActionType.ERROR_CREATING_USER,
    payload: payload,
    meta: meta,
    error: true
  };
...
var createUser = function createUser(request, meta) {
  ...
  thunkFunction.type = exports.UserActionType.CREATE_USER_COMMAND;
  return thunkFunction;
}; // end::RDX-command-user-create[]

var deletingUser = function deletingUser(payload, meta) {
  return {
    type: exports.UserActionType.DELETING_USER,
    payload: payload,
    meta: meta
  };
...
var userDeleted = function userDeleted(payload, meta) {
  return {
    type: exports.UserActionType.USER_DELETED,
    payload: payload,
    meta: meta
  };
...
var errorDeletingUser = function errorDeletingUser(payload, meta) {
  return {
    type: exports.UserActionType.ERROR_DELETING_USER,
    payload: payload,
    meta: meta,
    error: true
  };
...
var deleteUser = function deleteUser(request, meta) {
  ...
  thunkFunction.type = exports.UserActionType.DELETE_USER_COMMAND;
  return thunkFunction;
}; // end::RDX-command-user-delete[]

var fetchingUserById = function fetchingUserById(payload, meta) {
  return {
    type: exports.UserActionType.FETCHING_USER_BY_ID,
    payload: payload,
    meta: meta
  };
...
var userRetrieved = function userRetrieved(payload, meta) {
  return {
    type: exports.UserActionType.USER_RETRIEVED,
    payload: payload,
    meta: meta
  };
...
var errorFetchingUserById = function errorFetchingUserById(payload, meta) {
  return {
    type: exports.UserActionType.ERROR_FETCHING_USER_BY_ID,
    payload: payload,
    meta: meta,
    error: true
  };
...
var fetchUserById = function fetchUserById(request, meta) {
  ...
  thunkFunction.type = exports.UserActionType.FETCH_USER_BY_ID_COMMAND;
  return thunkFunction;
}; // end::RDX-command-user-fetchbyid[]

var fetchingUsers = function fetchingUsers(payload, meta) {
  return {
    type: exports.UserActionType.FETCHING_USERS,
    payload: payload,
    meta: meta
  };
...
var usersRetrieved = function usersRetrieved(payload, meta) {
  return {
    type: exports.UserActionType.USERS_RETRIEVED,
    payload: payload,
    meta: meta
  };
...
var errorFetchingUsers = function errorFetchingUsers(payload, meta) {
  return {
    type: exports.UserActionType.ERROR_FETCHING_USERS,
    payload: payload,
    meta: meta,
    error: true
  };
...
var fetchUsers = function fetchUsers(request, meta) {
  ...
  thunkFunction.type = exports.UserActionType.FETCH_USERS_COMMAND;
  return thunkFunction;
}; // end::RDX-command-user-fetch[]

var updatingUser = function updatingUser(payload, meta) {
  return {
    type: exports.UserActionType.UPDATING_USER,
    payload: payload,
    meta: meta
  };
...
var userUpdated = function userUpdated(payload, meta) {
  return {
    type: exports.UserActionType.USER_UPDATED,
    payload: payload,
    meta: meta
  };
...
var errorUpdatingUser = function errorUpdatingUser(payload, meta) {
  return {
    type: exports.UserActionType.ERROR_UPDATING_USER,
    payload: payload,
    meta: meta,
    error: true
  };
...
var updateUser = function updateUser(request, meta) {
  ...
  thunkFunction.type = exports.UserActionType.UPDATE_USER_COMMAND;
  return thunkFunction;
...
})(exports.PresenceActionType || (exports.PresenceActionType = {})); // end::RDX-enum-presence-action[]
...
var userUpdated$1 = function userUpdated(payload) {
  return {
    type: exports.UserActionType.USER_UPDATED_EVENT,
    payload: payload
  };
...
var userDeleted$1 = function userDeleted(payload) {
  return {
    type: exports.UserActionType.USER_DELETED_EVENT,
    payload: payload
  };
...
var spaceUpdated$1 = function spaceUpdated(payload) {
  return {
    type: exports.SpaceActionType.SPACE_UPDATED_EVENT,
    payload: payload
  };
...
var spaceDeleted$1 = function spaceDeleted(payload) {
  return {
    type: exports.SpaceActionType.SPACE_DELETED_EVENT,
    payload: payload
  };
...
var userMembershipUpdatedOnSpace = function userMembershipUpdatedOnSpace(payload) {
  return {
    type: exports.MembershipActionType.USER_MEMBERSHIP_UPDATED_ON_SPACE_EVENT,
    payload: payload
  };
};
...
var userAddedToSpace = function userAddedToSpace(payload) {
  return {
    type: exports.MembershipActionType.USER_ADDED_TO_SPACE_EVENT,
    payload: payload
  };
};
...
var userRemovedFromSpace = function userRemovedFromSpace(payload) {
  return {
    type: exports.MembershipActionType.USER_REMOVED_FROM_SPACE_EVENT,
    payload: payload
  };
...
})(exports.PresenceCategory || (exports.PresenceCategory = {})); // end::RDX-enum-presence-category[]
...
})(exports.ErrorStatusActionType || (exports.ErrorStatusActionType = {})); // end::RDX-enum-error-action[]
...
})(exports.NetworkStatusActionType || (exports.NetworkStatusActionType = {})); // end::RDX-enum-networkstatus-action[]
...
})(exports.SubscriptionStatusActionType || (exports.SubscriptionStatusActionType = {})); // end::RDX-enum-subscription-action[]
...
var createUserReducer = function createUserReducer() {
  return function (state, action) {
    ...
    switch (action.type) {
      case exports.UserActionType.USER_CREATED:
        return userCreated$1(state, action.payload);

      case exports.UserActionType.USER_UPDATED:
        return userUpdated$2(state, action.payload);

      case exports.UserActionType.USER_DELETED:
        return userDeleted$2(state, action.payload);

      case exports.UserActionType.USERS_RETRIEVED:
        return usersRetrieved$1(state, action.payload);

      case exports.UserActionType.USER_RETRIEVED:
        return userRetrieved$1(state, action.payload);

      case exports.UserActionType.USER_UPDATED_EVENT:
        return userUpdatedEventReceived(state, action.payload);

      case exports.UserActionType.USER_DELETED_EVENT:
        return userDeletedEventReceived(state, action.payload);

      case exports.MembersActionType.MEMBERS_RETRIEVED:
...
var createSpaceReducer = function createSpaceReducer() {
  return function (state, action) {
    ...
    switch (action.type) {
      case exports.SpaceActionType.SPACE_CREATED:
        return spaceCreated$1(state, action.payload);

      case exports.SpaceActionType.SPACE_UPDATED:
        return spaceUpdated$2(state, action.payload);

      case exports.SpaceActionType.SPACE_DELETED:
        return spaceDeleted$2(state, action.payload);

      case exports.SpaceActionType.SPACES_RETRIEVED:
        return spacesRetrieved$1(state, action.payload);

      case exports.SpaceActionType.SPACE_RETRIEVED:
        return spaceRetrieved$1(state, action.payload);

      case exports.SpaceActionType.SPACE_UPDATED_EVENT:
        return spaceUpdatedEventReceived(state, action.payload);

      case exports.SpaceActionType.SPACE_DELETED_EVENT:
        return spaceDeletedEventReceived(state, action.payload);

      case exports.MembershipActionType.MEMBERSHIP_RETRIEVED:
...
var createMembershipReducer = function createMembershipReducer() {
  return function (state, action) {
    ...
    switch (action.type) {
      case exports.MembershipActionType.MEMBERSHIP_RETRIEVED:
      case exports.MembershipActionType.MEMBERSHIP_UPDATED:
      case exports.MembershipActionType.SPACES_JOINED:
      case exports.MembershipActionType.SPACES_LEFT:
        return membershipResult(state, action.payload);

      case exports.MembershipActionType.USER_ADDED_TO_SPACE_EVENT:
        return userAddedToSpace$1(state, action.payload);

      case exports.MembershipActionType.USER_REMOVED_FROM_SPACE_EVENT:
        return userRemovedFromSpace$1(state, action.payload);

      case exports.MembershipActionType.USER_MEMBERSHIP_UPDATED_ON_SPACE_EVENT:
...
var createMembersReducer = function createMembersReducer() {
  return function (state, action) {
    ...
    switch (action.type) {
      case exports.MembersActionType.MEMBERS_RETRIEVED:
      case exports.MembersActionType.MEMBERS_UPDATED:
      case exports.MembersActionType.MEMBERS_ADDED:
      case exports.MembersActionType.MEMBERS_REMOVED:
...
exports.addingMembers = addingMembers;
...
exports.createSpaceListener = createSpaceListener;
...
exports.createUserListReducer = createUserListReducer;
exports.createUserListener = createUserListener;
exports.createUserReducer = createUserReducer;
exports.creatingSpace = creatingSpace;
exports.creatingUser = creatingUser;
exports.decryptionError = decryptionError;
exports.deleteSpace = deleteSpace;
exports.deleteUser = deleteUser;
exports.deletingSpace = deletingSpace;
exports.deletingUser = deletingUser;
exports.errorAddingMembers = errorAddingMembers;
exports.errorCreatingSpace = errorCreatingSpace;
exports.errorCreatingUser = errorCreatingUser;
exports.errorDeletingSpace = errorDeletingSpace;
exports.errorDeletingUser = errorDeletingUser;
exports.errorFetchingHereNow = errorFetchingHereNow;
exports.errorFetchingMembers = errorFetchingMembers;
exports.errorFetchingMembership = errorFetchingMembership;
...
exports.errorFetchingSpaceById = errorFetchingSpaceById;
exports.errorFetchingSpaces = errorFetchingSpaces;
exports.errorFetchingUserById = errorFetchingUserById;
exports.errorFetchingUsers = errorFetchingUsers;
exports.errorJoiningSpaces = errorJoiningSpaces;
exports.errorLeavingSpaces = errorLeavingSpaces;
exports.errorRemovingMembers = errorRemovingMembers;
exports.errorSendingMessage = errorSendingMessage;
exports.errorSendingSignal = errorSendingSignal;
exports.errorUpdatingMembers = errorUpdatingMembers;
exports.errorUpdatingMembership = errorUpdatingMembership;
exports.errorUpdatingSpace = errorUpdatingSpace;
exports.errorUpdatingUser = errorUpdatingUser;
...
exports.fetchingMembers = fetchingMembers;
exports.fetchingMembership = fetchingMembership;
exports.fetchingMessageHistory = fetchingMessageHistory;
exports.fetchingPresenceState = fetchingPresenceState;
exports.fetchingSpaceById = fetchingSpaceById;
exports.fetchingSpaces = fetchingSpaces;
exports.fetchingUserById = fetchingUserById;
exports.fetchingUsers = fetchingUsers;
exports.hereNowRetrieved = hereNowRetrieved;
exports.joinSpaces = joinSpaces;
exports.joiningSpaces = joiningSpaces;
exports.leaveSpaces = leaveSpaces;
exports.leavingSpaces = leavingSpaces;
exports.malformedResponse = malformedResponse;
exports.membersAdded = membersAdded;
exports.membersRemoved = membersRemoved;
exports.membersRetrieved = membersRetrieved;
exports.membersUpdated = membersUpdated;
exports.membershipRetrieved = membershipRetrieved;
exports.membershipUpdated = membershipUpdated;
...
exports.removingMembers = removingMembers;
...
exports.spaceCreated = spaceCreated;
exports.spaceDeleted = spaceDeleted;
exports.spaceRetrieved = spaceRetrieved;
exports.spaceUpdated = spaceUpdated;
exports.spacesJoined = spacesJoined;
exports.spacesLeft = spacesLeft;
exports.spacesRetrieved = spacesRetrieved;
...
exports.updatingMembers = updatingMembers;
exports.updatingMemberships = updatingMemberships;
exports.updatingSpace = updatingSpace;
...
exports.usersRetrieved = usersRetrieved;
