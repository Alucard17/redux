...
import { FetchMessageHistoryRequest, FetchMessageHistoryError, FetchingMessageHistoryAction, ErrorFetchingMessageHistoryAction, MessageHistoryRetrievedAction, FetchMessageHistorySuccess } from '../../message/MessageActions';
import { MessageActionType } from '../../message/MessageActionType.enum';
import { PubnubThunkContext } from '../../../foundations/ThunkTypes';
import { ActionMeta } from '../../../foundations/ActionMeta';
export declare const fetchingMessageHistory: <Meta extends ActionMeta>(payload: FetchMessageHistoryRequest, meta?: Meta | undefined) => FetchingMessageHistoryAction<Meta>;
...
export declare const fetchMessageHistory: <MessageContentType, Meta extends ActionMeta>(request: FetchMessageHistoryRequest, meta?: Meta | undefined) => {
